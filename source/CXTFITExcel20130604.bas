...
If (Abs(ci) > 0.0000000001) Then
    MIM = MIM + IVP(ci, T, Z, 0#, p, beta, _
                    omega, R, mu1, mu2, strFluxConc, strMobile, tol, strNI, bln, nPoint)
End If
...
Dim q1, q2, q3, q4, q5, q6, q7, q8, q9 As Double
P1 = 1#
P2 = 3.5156229
P3 = 3.0899424
P4 = 1.2067492
...
If (Abs(x) < 3.75) Then
    y = x * x / 3.75 / 3.75
    EXPBI0 = Exp(Z) * (P1 + y * (P2 + y * (P3 + y * (P4 + y * (P5 + y * (P6 + y * P7))))))
Else
    ax = Abs(x)
    y = 3.75 / ax
    EXPBI0 = Exp(Z + ax) / Sqr(ax) * ( _
...
If (Abs(x) < 3.75) Then
    y = x * x / 3.75 / 3.75
    EXPBI1 = x * Exp(Z) * (P1 + y * (P2 + y * (P3 + y * (P4 + y * (P5 + y * (P6 + y * P7))))))
Else
    ax = Abs(x)
    y = 3.75 / ax
    EXPBI1 = Exp(Z + ax) / Sqr(ax) * (q1 + y * (q2 + y * (q3 + y * (q4 + y * (q5 + y * (q6 + y * (q7 + y * (q8 + y * q9))))))))
    If (x < 0#) Then
        EXPBI1 = -1# * EXPBI1
    End If
End If
...
Public Function IVP(ByVal ci As Double, _
    ...
    Select Case LCase(strNI)
        Case "romberg"
            IVP = ROMB("EqInt337", 0.0000000001, T - 0.0000000001, tol, bln, T, Z, Zi, p, beta, omega, R, mu1, mu2, strFluxConc, strMobile)
        
        Case "simpson"
            IVP = AdaptSim("EqInt337", 0.0000000001, T - 0.0000000001, tol, bln, T, Z, Zi, p, beta, omega, R, mu1, mu2, strFluxConc, strMobile)
        
        Case "lobatto"
            IVP = AdaptLob("EqInt337", 0.0000000001, T - 0.0000000001, tol, bln, T, Z, Zi, p, beta, omega, R, mu1, mu2, strFluxConc, strMobile)
        ...
        Case "chebyshev"
            ...
            If (nPoint < 1) Then
                nPoint = 1
            End If
            IVP = ChebyQ("EqInt337", 0.0000000001, T - 0.0000000001, nPoint, bln, T, Z, Zi, p, beta, omega, R, mu1, mu2, strFluxConc, strMobile)
    End Select
    
'    IVP = ROMBLN("EqInt337", 0.0000000001, T - 0.0000000001, tol, T, Z, Zi, p, beta, omega, r, mu1, mu2, bFluxConc)
    Select Case LCase(strMobile)
        Case "mobile"
            IVP = IVP * omega / beta / R * ci + Exp(-omega * T / beta / R) * Psi1N(Z, Zi, T, p, beta, R, mu1, strFluxConc)
        Case Else
            IVP = IVP * omega / (1# - beta) / R * ci + Exp(-(omega + mu2) * T / (1# - beta) / R) * ci
    End Select
...
Private Function EqInt337(ByVal tau As Double, _
    ...
    ax = 2# * omega / R * Sqr((T - tau) * tau / beta / (1# - beta))
    bx = -omega * tau / beta / R - (omega + mu2) * (T - tau) / (1# - beta) / R
    Select Case LCase(strMobile)
        Case "mobile"
            EqInt337 = EXPBI0(ax, bx) + Sqr(beta * tau / (1# - beta) / (T - tau)) * EXPBI1(ax, bx)
            EqInt337 = EqInt337 * Psi1N(Z, Zi, tau, p, beta, R, mu1, strFluxConc)
        Case Else
            EqInt337 = EXPBI0(ax, bx) + Sqr((1# - beta) * (T - tau) / beta / tau) * EXPBI1(ax, bx)
            EqInt337 = EqInt337 * Psi1N(Z, Zi, tau, p, beta, R, mu1, strFluxConc)
    End Select
...
Public Function ChebyQ(ByVal func As String, _
                         ...
                         Optional ByVal P11 As Variant) As Double
    ...
    For k = 1 To n
        ...
        If (ln) Then
            ...
            fk = Run(func, Exp(xk), P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * Exp(xk)
        Else
            xk = 0.5 * ((b - a) * tk + (a + b))
            fk = Run(func, xk, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
        End If
        fk = fk * Sqr(1# - tk * tk)
        qq = qq + fk
    Next
...
Public Function ROMB(ByVal func As String, _
                      ...
                      Optional ByVal P9 As Variant, _
                      Optional ByVal P10 As Variant, _
                      Optional ByVal P11 As Variant) _
                      As Double
...
If (ln) Then
    R(1, 1) = 0.5 * (Log(b) - Log(a)) * (Run(func, a, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * a + Run(func, b, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * b)
    h = Log(b) - Log(a)
Else
    R(1, 1) = 0.5 * (b - a) * (Run(func, a, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + Run(func, b, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11))
    h = b - a
End If
...
'   From R(k, 1) to R(k + 1, 1)
    ...
    For I = 1 To 2 ^ (J - 2)
        If (ln) Then
            R(J, 1) = R(J, 1) + h * Run(func, Exp(Log(a) + (2 * I - 1) * h), P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * Exp(Log(a) + (2 * I - 1) * h)
        Else
            R(J, 1) = R(J, 1) + h * Run(func, a + (2 * I - 1) * h, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
        End If
    Next
...
If (ln) Then
    m = (Log(b) + Log(a)) / 2#
    fm = Run(func, Exp(m), P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * Exp(m)
    fa = Run(func, a, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * a
    fb = Run(func, b, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * b
Else
    m = (b + a) / 2#
    fm = Run(func, m, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fa = Run(func, a, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fb = Run(func, b, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
End If

AdaptSim = AdaptSimStp(func, a, b, fa, fm, fb, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
...
If (ln) Then
    m = (Log(b) + Log(a)) / 2#
    h = (Log(b) - Log(a)) / 4#
    fml = Run(func, Exp(Log(a) + h), P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * Exp(Log(a) + h)
    fmr = Run(func, Exp(Log(b) - h), P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * Exp(Log(b) - h)
    m = Exp(m)
Else
    m = (b + a) / 2#
    h = (b - a) / 4#
    fml = Run(func, a + h, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fmr = Run(func, b - h, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
End If
...
If ((Abs(i1 - i2) < tol * i1) Or (i1 < tol)) Then
    AdaptSimStp = i1
Else
    AdaptSimStp = AdaptSimStp(func, a, m, fa, fml, fm, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptSimStp(func, m, b, fm, fmr, fb, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
End If
...
AdaptLob = AdaptLobStp(func, a, b, fa, fb, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
...
If (ln) Then
    ...
    fmll = Run(func, mll, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * mll
    fml = Run(func, ml, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * ml
    fm = Run(func, m, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * m
    fmr = Run(func, mr, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * mr
    fmrr = Run(func, mrr, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) * mrr
Else
    h = (b - a) / 2#
    m = (a + b) / 2#
    ...
    fmll = Run(func, mll, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fml = Run(func, ml, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fm = Run(func, m, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fmr = Run(func, mr, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
    fmrr = Run(func, mrr, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
End If
...
If (Abs(i1 - i2) < tol * i1) Or (mll <= a) Or (b <= mrr) Or (i1 < tol) Then
    AdaptLobStp = i1
Else
    AdaptLobStp = AdaptLobStp(func, a, mll, fa, fmll, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptLobStp(func, mll, ml, fmll, fml, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptLobStp(func, ml, m, fml, fm, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptLobStp(func, m, mr, fm, fmr, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptLobStp(func, mr, mrr, fmr, fmrr, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) + _
                  AdaptLobStp(func, mrr, b, fmrr, fb, tol, ln, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)
  End If
